...
# user imports
from runner.experiments.gad.template.template import ExperimentDownstreamTemplate
from runner.models.nnunet import NNUNet
from runner.experiments.gad import experiment_setup
from runner.models.downstream import Downstream
...
class Hyperparameters:
    ...
    bins: List = [0, 1, 2, 3, 4]
    flags: Dict = {'residual_block': False, 'instance_norm': False}
    ...
    schedulers: Dict[str, Dict] = {'unet_scheduler': {'gamma': 0.995,
                                   ...
                                   'downstream_scheduler': {'gamma': 0.995,
                                                          'last_epoch': -1
                                                          }
                                   }
    criterions: Dict[str, Dict] = {'unet_loss': {'weighted': True, 'pos_weight': 3.0},
                                   'downstream_loss': {'weighted': False, 'decaying': False, 'pos_weight': None}}
...
class ExperimentDescription(ExperimentDownstreamTemplate):
    def __init__(self):
